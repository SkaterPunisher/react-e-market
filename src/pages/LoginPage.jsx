...
import { getUser, logIn } from '../features/initialUsers/initialUsersSlice'
...
const LoginPage = () => {
  ...
  return (
    <div className='flex justify-center flex-col items-center'>
        ...
        <form onSubmit={handleSubmit} className=' px-6 py-4 flex flex-col bg-slate-100 max-w-[500px]'>
          <label >
